...
# ضمان وجود الأعمدة حتى لو كانت الشيت فارغة لتجنب KeyError
if 'v_date_dt' not in df_m.columns:
    df_m['v_date_dt'] = pd.to_datetime([]) # إنشاء عمود تاريخ فارغ
...
if not df_exp.empty:
    ...
    df_exp['exp_date_dt'] = pd.to_datetime([])
